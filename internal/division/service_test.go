...
func TestService_CreateDivision(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := svc.CreateDivision(context.Background(), tc.req)
...
func TestService_ListDivisions(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			result, total, err := svc.ListDivisions(context.Background(), tc.params)
...
func TestService_GetDivision(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := svc.GetDivision(context.Background(), tc.id)
...
func TestService_UpdateDivision(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			err := svc.UpdateDivision(context.Background(), tc.id, tc.req)
