...
func TestService_CreateCategory(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := svc.CreateCategory(context.Background(), tc.req)
...
func TestService_ListCategories(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			result, total, err := svc.ListCategories(context.Background(), tc.params)
...
func TestService_GetCategory(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := svc.GetCategory(context.Background(), tc.id)
...
func TestService_UpdateCategory(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			err := svc.UpdateCategory(context.Background(), tc.id, tc.req)
